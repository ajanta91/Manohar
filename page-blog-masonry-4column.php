<?php
/**
 * Template Name: Blog masonry four column
 */
get_header();
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row blog_masonry" id="blog_masonry">
                    ...
                    <div class="col-md-3 col-xs-6 blog_item">
                        <div class="post mb-20">
                            <div class="post-img"> <?php the_post_thumbnail('manohar_260x999', array('class'=>'img-responsive')) ?> </div>
                            <div class="post-info">
