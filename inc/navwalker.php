...
if ( ! class_exists( 'Manohar_Nav_Navwalker' ) ) {
    /**
     * Travel_Bootstrap_Navwalker class.
     *
     * @extends Walker_Nav_Menu
     */
    class Manohar_Nav_Navwalker extends Walker_Nav_Menu {
        ...
        public static function fallback( $args ) {
            if ( current_user_can( 'edit_theme_options' ) ) {
                ...
                echo '>';
                echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_attr( 'Add a menu', 'gullu' ) . '</a></li>';
                echo '</ul>';
                if ( $container ) {
                    echo '</' . esc_attr( $container ) . '>';
                }
