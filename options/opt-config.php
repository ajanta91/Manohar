...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme settings', 'manohar' ),
	'page_title'           => esc_html__( 'Manohar theme settings', 'manohar' ),
...
$content = wp_kses(__( '<p>Here are some important links.</p>', 'manohar' ), $allowed_string);
